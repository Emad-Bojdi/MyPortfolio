...
const Footer = () => {
  return (
    <>
      <div className="w-full h-auto bg-cyan-950 sm:flex sm:flex-wrap sm:justify-center p-6 py-24 block">
        ...
        <div className=" h-auto w-full sm:basis-1/2 lg:basis-1/4 lg:m-6">
          ...
          <div className="relative sm:w-4/5 lg:w-full">
            <input type="text" className="w-full h-10 rounded-sm outline-none p-4 text-sm text-gray-300 " placeholder="Enter Email Address"/>
        ...
        <div className="w-1/5 h-auto lg:m-6 msm:w-full mt-4 lg:basis-1/5">
          ...
          <p className="py-6 text-gray-500 text-sm">let us be social</p> 
